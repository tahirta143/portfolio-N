    ...
    <section id="background" className="border-t border-[#0A66C2]/20 bg-white py-28 text-zinc-900 transition-colors duration-300 dark:bg-black dark:text-zinc-100">
      <div className="mx-auto max-w-7xl px-6 md:px-12">
        <FadeUp className="mb-16">
          <Badge variant="outline" className="mb-3 rounded-full">07 // BACKGROUND & PROCESS</Badge>
          <motion.h2
          ...
          <p className="mt-2 max-w-2xl text-sm font-light leading-relaxed text-zinc-600 dark:text-zinc-400">
            My Computer Engineering background and hands-on GoHighLevel experience help me build practical, reliable systems around the way your business works.
          </p>
        ...
        <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
          ...
          <div>
            <p className="mb-6 text-xs font-bold uppercase tracking-widest text-[#0A66C2]">How I Work</p>
            <StaggerContainer className="grid gap-4 sm:grid-cols-2">
              {process.map((step) => {
                const Icon = step.icon;
                return (
                  <motion.div key={step.number} variants={motionItem}>
                    <GlowHoverCard className="h-full">
                      ...
                      <div className="mt-4 space-y-1.5 pt-3 border-t border-[#0A66C2]/15">
                        {step.tags.map((tag) => (
