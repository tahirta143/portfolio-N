...
const projects = [
  { id: "a2p-assisted-living", title: "ASSISTED LIVING A2P 10DLC", category: "A2P", image: "/assets/A2P/Assisted Living #U2014 A2P 10DLC Approval.png", description: "A compliant A2P 10DLC registration system for assisted living businesses sending trusted messages and calls.", tech: ["A2P 10DLC", "Trust Center", "Messaging", "Voice"] },
  { id: "a2p-roofing", title: "ROOFING BUSINESS A2P 10DLC", category: "A2P", image: "/assets/A2P/Roofing Business #U2014 A2P 10DLC Approval.png", description: "A verified messaging setup helping roofing businesses improve SMS deliverability and customer trust.", tech: ["A2P 10DLC", "SMS", "SHAKEN/STIR", "Compliance"] },
  { id: "a2p-perk-practical", title: "PERK PRACTICAL A2P 10DLC", category: "A2P", image: "/assets/A2P/PERK Practical #U2014 A2P 10DLC.png", description: "A business messaging and voice registration system built for reliable communication and stronger connectivity.", tech: ["A2P 10DLC", "Voice", "Messaging", "Trust"] },
  ...
  { id: "automation-ascend", title: "ASCEND EQUITY FUND WORKFLOWS", category: "Automation System", image: "/assets/Automation System/Ascend Equity Fund #U2013 Investor Automation System.png", description: "Seven connected investor workflows covering capture, qualification, appointments, nurturing, and conversion.", tech: ["Investor Leads", "Qualification", "Automation", "Email"] },
  ...
  { id: "website-calibre", title: "CALIBRE CLEANING", category: "GHL Sales Funnels and Websites", image: "/assets/GHL Sales Funnel and Websites/Calibre Cleaning #U2013 GoHighLevel Cleaning Website.png", description: "A lead generation website for a professional cleaning company with service messaging and estimate capture.", tech: ["GHL Website", "Cleaning", "Lead Generation", "Forms"], url: "https://sites.leadconnectorhq.com/preview/97o6PbffLbToQenX530g?notrack=true" },
...
export function ProjectsSection() {
  ...
  const projectRows = [];
  for (let index = 0; index < filteredProjects.length; index += 7) {
    projectRows.push(filteredProjects.slice(index, index + 7));
  }
