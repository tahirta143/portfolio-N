...
const skillCategories = [
  {
    ...
    icon: Code2,
    skills: [
      { name: "GoHighLevel CRM Setup", level: "Core Skill", experience: "3+ Years Experience" },
      { name: "Sales Funnels & Landing Pages", level: "Core Skill", experience: "3+ Years Experience" },
      { name: "CRM & Pipeline Systems", level: "Core Skill", experience: "Advanced" },
      { name: "Forms & Surveys", level: "Funnels", experience: "3+ Years Experience" },
      { name: "Calendar & Appointment Systems", level: "Core Skill", experience: "3+ Years Experience" },
      { name: "GHL Snapshot Development", level: "Core Skill", experience: "2+ Years Experience" },
    ],
  },
  {
    id: "backend",
    ...
    icon: Server,
    skills: [
      { name: "Workflow Automation", level: "Automation", experience: "Advanced" },
      { name: "AI Chat & Voice Agents", level: "AI Automation", experience: "Hands-on" },
      { name: "Email & SMS Automation", level: "Automation", experience: "3+ Years Experience" },
      { name: "Review Request Automation", level: "Automation", experience: "2+ Years Experience" },
      { name: "Reputation Management", level: "Automation", experience: "2+ Years Experience" },
      { name: "A2P / 10DLC Setup", level: "Compliance", experience: "1+ Years Experience" },
    ],
  },
  {
    id: "devops",
    ...
    icon: Wrench,
    skills: [
      { name: "Zapier / Make / N8N", level: "Integrations", experience: "3+ Years Experience" },
      { name: "Webhooks & API Integrations", level: "Integrations", experience: "3+ Years Experience" },
      { name: "Stripe / PayPal Payments", level: "Integrations", experience: "2+ Years Experience" },
      { name: "Twilio / LC Phone / LC Email", level: "Integrations", experience: "2+ Years Experience" },
      { name: "Email Deliverability (SPF/DKIM/DMARC)", level: "Deliverability", experience: "2+ Years Experience" },
      { name: "GHL White-Label & SaaS Setup", level: "Integrations", experience: "2+ Years Experience" },
    ],
  },
];
